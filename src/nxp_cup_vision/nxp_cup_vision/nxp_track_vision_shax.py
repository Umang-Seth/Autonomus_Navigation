...
class NXPTrackVision(Node):
    ...
    def findLines(self, passedImage):
        ...
        maskVehicleBoxTopLeftXY = (int(imageWidth*(0.986-self.maskRectRatioWidthHeight[0])/2.0), 
            int(imageHeight*(1.18-self.maskRectRatioWidthHeight[1])))
        ...
        for cn in cnt:
            ...
            if (linePointX >= 1.0) and (linePointY >= 1.0):
                ...
                self.lineMethodsUsedCount[self.lineMethodUsed]+=2
